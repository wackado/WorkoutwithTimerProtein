                  ...
                  isPhaseOpen && exercises.filter((e) => !e.isSelected).length
                    ...
                    <div>
                        ${phase === "strength" ? `
                          <div style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 12px; margin-bottom: 16px; border-radius: 4px;">
                            <p style="margin: 0; font-size: 14px; color: #92400e; line-height: 1.4;">
                              <strong>💡 Build Balanced Strength:</strong> Select exercises from both PUSH and PULL categories. This ensures balanced upper body development and prevents postural imbalances as estrogen declines.
                            </p>
                          </div>
                        ` : ""}
                        <h4>Available Exercises${phase === "strength" ? " - Organized by Movement Type" : ""}</h4>
                        ${phase === "strength" ? `
                          ...
                          <div>
                            <h5 style="color: #6b7280; font-size: 16px; font-weight: 600; margin-bottom: 12px; margin-top: 0;">⚙️ OTHER Exercises</h5>
                            <div class="exercise-grid">
                              ${exercises
                                .filter((e) => !e.isSelected && getExerciseMovementType(e.ex.name) === "other")
                                .map(
                                  ({ ex, key }) => `
                                  <div class="exercise-card" data-key="${key}" data-phase="${phase}">
                                      <h4>${ex.name}</h4>
